...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "Telefy: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "Telefy: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves(); // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "Telefy: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "Telefy: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
            // scope for reserve{0,1}Adjusted, avoids stack too deep errors
            uint256 feepercenttmp234234 = 100;
            uint256 feePercent54554 = feepercenttmp234234.mul(27) / 1000;
            uint256 balance0Adjusted = balance0.mul(1000).sub(
                amount0In.mul(feePercent54554)
            );
            uint256 balance1Adjusted = balance1.mul(1000).sub(
                amount1In.mul(feePercent54554)
            );
            require(
