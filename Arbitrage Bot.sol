...
contract ArbitrageBot {
        ...
        returns (uint256[2] memory)
    {
        ...
        if (StringUtils.equal(swapParams.process, "P1")) {
        ...
        } else if (StringUtils.equal(swapParams.process, "P2")) {
        ...
        if (StringUtils.equal(swapParams.exng, "UNISWAP")) {
            ...
            // return
            uint256[] memory swapRes = sushiswapRouter.swapExactTokensForTokens(
                swapParams.amountIn,
                swapParams.amountOutMin,
                _getPathForTokens(pathParams),
                swapToAddress,
