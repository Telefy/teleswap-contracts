...
contract ArbitrageBot {
    ...
    function executeSwap(
        ...
        */
        ...
        // Swap process 1
        uint256[] memory FromExngAmountOuts = _swap(swapParams1);
        swapParams2.amountIn = FromExngAmountOuts[1];

        // Swap process 2
        uint256[] memory toExngAmountOuts = _swap(swapParams2);
        ...
        returns (uint256[] memory)
    {
        ...
        if (swapParams.process == 1) {
            ...
            swapToAddress = address(this);
        } else if (swapParams.process == 2) {
            swapToAddress = msg.sender;
        }
        uint256[] memory dummyReturn;
        return dummyReturn;
